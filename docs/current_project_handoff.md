...
7. if a new Brev instance is required for the batch, use
   ...
   It disarms automatically if either local readiness gate fails or the prepare
   sequence is interrupted after the local env has been armed.
