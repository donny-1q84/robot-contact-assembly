...
- What comes next: generate demonstrations around the shallow success window, then train a learned final-contact policy or imitation policy for the last contact-retention phase.
