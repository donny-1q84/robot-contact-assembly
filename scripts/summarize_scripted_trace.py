        ...
        rows.append(
            {
                ...
                "insert_force_xy": step.get("insert_contact_force_aware_xy"),
                "insert_force_active": step.get("insert_contact_force_active"),
                "insert_force_offset": _vec_dist(step.get("insert_contact_force_xy_offset_w"), [0.0, 0.0, 0.0]),
                "socket_servo": step.get("socket_insertion_servo_active"),
                "socket_recovery": step.get("socket_insertion_servo_recovery"),
                "socket_soft_exit": step.get("socket_insertion_servo_soft_exit"),
                "socket_hard_exit": step.get("socket_insertion_servo_hard_exit"),
                "socket_rotate": step.get("socket_insertion_servo_rotate"),
                "socket_ori_hold": step.get("socket_insertion_servo_orientation_hold"),
                "jcache": step.get("joint_cache_active"),
                "jcache_seed": step.get("joint_cache_seed"),
                "jcache_live_polish": step.get("joint_cache_live_polish"),
