...
def render_markdown(all_checks: Iterable[Check]) -> str:
    ...
    lines.extend(
        [
            ...
            "python3 scripts/plan_v0_robot_adapter_manifest.py --robot-id <target_robot_id> --robot-family <target_robot_family> --end-effector <tool_or_gripper> --joint-trajectory-action <joint_trajectory_action_or_vendor_bridge> --joint-state-feedback <joint_state_feedback_topic> --ee-pose-feedback <ee_pose_feedback_topic> --cartesian-command-or-ik <cartesian_command_or_ik_interface> --end-effector-command <tool_or_gripper_command_interface> --force-torque-or-contact-feedback <force_torque_or_contact_feedback> --skill-status <skill_status_topic> --no-output",
            ...
            "python3 scripts/prepare_v0_portability_review.py --target-robot-id <target_robot_id> --target-robot-family <target_robot_family> --end-effector <tool_or_gripper> --joint-trajectory-action <joint_trajectory_action_or_vendor_bridge> --joint-state-feedback <joint_state_feedback_topic> --ee-pose-feedback <ee_pose_feedback_topic> --cartesian-command-or-ik <cartesian_command_or_ik_interface> --end-effector-command <tool_or_gripper_command_interface> --force-torque-or-contact-feedback <force_torque_or_contact_feedback> --skill-status <skill_status_topic> --skip-phase2-contact-gate --no-output",
