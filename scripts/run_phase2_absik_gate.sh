...
export RCA_GATE_EXTRA_AGENT_ARGS="${RCA_GATE_EXTRA_AGENT_ARGS:---deterministic-reset --socket-pos 0.22,0.04,0.19 --staged-approach --rotate-before-descend --rotate-control-mode target --approach-xy-tol 0.04 --insert-xy-tol 0.0015 --insert-rot-tol 0.12 --insert-abort-xy-tol 0.04 --insert-abort-rot-tol 0.35 --abs-control-mode waypoint --abs-pos-step 0.030 --abs-rot-step 0.12 --insert-pos-step 0.010 --insert-rot-step 0.06 --debug-action-steps 4}"
