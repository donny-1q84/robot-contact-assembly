...
export RCA_GATE_INSTANCE_NAME="${RCA_GATE_INSTANCE_NAME:-isaac-phase2-control-jointpos-l4}"
...
# Control-mode comparison baseline:
# - JointPositionActionCfg task
# - standalone Cartesian joint-IK pre-controller
# - same strict shallow-contact gate used by the final force-aware near miss
