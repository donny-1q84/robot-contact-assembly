...
def build_report(config_path: Path, *, brev_safety_output: Path | None = None) -> dict[str, Any]:
    ...
    _int_value(values, "RCA_SUCCESS_VARIATION_SETUP_RESERVE_SECONDS", blockers)
    _int_value(values, "RCA_SUCCESS_VARIATION_TIMEOUT_MARGIN_SECONDS", blockers)
    _int_value(values, "RCA_SUCCESS_VARIATION_CASE_CALIBRATION_TIMEOUT_SECONDS", blockers)
    _int_value(values, "RCA_SUCCESS_VARIATION_CASE_TRACE_TIMEOUT_SECONDS", blockers)
    _int_value(values, "RCA_SUCCESS_VARIATION_TRACE_TIMEOUT_KILL_SECONDS", blockers)
    reuse_calibration = values.get("RCA_SUCCESS_VARIATION_REUSE_CALIBRATION", "").strip()
