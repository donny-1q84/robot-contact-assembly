...
ROBOT_SPECIFIC_LAYERS = [
    ...
    "calibration_error_bounds_and_frame_round_trip",
    "joint_cartesian_tool_and_feedback_interfaces",
    "force_torque_or_contact_feedback_thresholds",
    "controller_interface_units_and_acknowledgement",
    "rate_limits_timeouts_force_limits_and_abort_conditions",
...
def build_report(
    *,
    ...
    return {
        ...
        "review_scope": "named_robot_low_speed_review_only" if ready else "blocked_named_robot_adapter_review",
        "hardware_execution_boundary": "offline portability review only; no robot execution is approved by this gate",
