...
export RCA_GATE_INSTANCE_NAME="${RCA_GATE_INSTANCE_NAME:-isaac-phase2-force-aware-contact-retention-l4}"
...
# Structural follow-up to XY-hold contact retention:
# - keep early retention and strict success unchanged
# - do not latch a fixed off-center XY anchor
# - use the socket-frame contact-force direction to apply a bounded XY centering offset
# - keep a gentle Z preload so contact is not lost during final rotation settling.
